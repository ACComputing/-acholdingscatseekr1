...
- MLA + MoE (DeepSeek-R1 style) with proper causal attention
...
# =============================================================================
# DeepSeek-R1 Style Architecture (MLA + MoE) with proper causal attention
# =============================================================================
class DeepSeekMLA:
...
class ConsoleBitNetR1:
    def __init__(self):
        ...
        self.vocab = ["meow", "喵", "think", "optimize", "bitnet", "fast", "cat", "AI", "model",
                      "is", "very", "good", "speed", "4bit", "2B", "R1", "deepseek", "python",
